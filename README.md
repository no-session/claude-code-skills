...
| [product-ideation](./skills/product-ideation/) | Find, sharpen, and validate app/product ideas. Generation lenses (PG, schlep blindness, niches, tailwinds), scoring rubric (painkiller vs vitamin, WTP, founder-market fit), Mom Test interview scripts, and a validation ladder from demand-signal scans through pre-sells. |
